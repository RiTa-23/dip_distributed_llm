...
var getExceptionMessageCommon = ptr => {
  ...
  var type_addr = Number((growMemViews(), HEAPU64)[((type_addr_addr) >> 3)]);
  var message_addr = Number((growMemViews(), HEAPU64)[((message_addr_addr) >> 3)]);
...
var WebGPU = {
  ...
  iterateExtensions: (root, handlers) => {
    assert(root);
    for (var ptr = Number((growMemViews(), HEAPU64)[((root) >> 3)]); ptr; ptr = Number((growMemViews(), 
    HEAPU64)[((ptr) >> 3)])) {
      var sType = (growMemViews(), HEAP32)[(((ptr) + (8)) >> 2)];
  ...
  makeComputeState: ptr => {
    if (!ptr) return undefined;
    assert(ptr);
    assert(Number((growMemViews(), HEAPU64)[((ptr) >> 3)]) === 0);
    var desc = {
  ...
  makeComputePipelineDesc: descriptor => {
    assert(descriptor);
    assert(Number((growMemViews(), HEAPU64)[((descriptor) >> 3)]) === 0);
    var desc = {
  ...
  makeRenderPipelineDesc: descriptor => {
    ...
    function makePrimitiveState(psPtr) {
      ...
      assert(psPtr);
      assert(Number((growMemViews(), HEAPU64)[((psPtr) >> 3)]) === 0);
      return {
    ...
    function makeColorState(csPtr) {
      assert(csPtr);
      assert(Number((growMemViews(), HEAPU64)[((csPtr) >> 3)]) === 0);
    ...
    function makeVertexState(viPtr) {
      ...
      assert(viPtr);
      assert(Number((growMemViews(), HEAPU64)[((viPtr) >> 3)]) === 0);
      var desc = {
    ...
    function makeMultisampleState(msPtr) {
      ...
      assert(msPtr);
      assert(Number((growMemViews(), HEAPU64)[((msPtr) >> 3)]) === 0);
      return {
    ...
    function makeFragmentState(fsPtr) {
      ...
      assert(fsPtr);
      assert(Number((growMemViews(), HEAPU64)[((fsPtr) >> 3)]) === 0);
      var desc = {
  ...
  fillLimitStruct: (limits, limitsOutPtr) => {
    assert(limitsOutPtr);
    assert(Number((growMemViews(), HEAPU64)[((limitsOutPtr) >> 3)]) === 0);
  ...
  fillAdapterInfoStruct: (info, infoStruct) => {
    assert(infoStruct);
    assert(Number((growMemViews(), HEAPU64)[((infoStruct) >> 3)]) === 0);
  ...
  FeatureName: {
    ...
    327730: "chromium-experimental-multi-draw-indirect"
  },
  ...
  WGSLLanguageFeatureName: [ , "readonly_and_readwrite_storage_textures", "packed_4x8_integer_dot_product", "unrestricted_pointer_parameters", "pointer_composite_access", "uniform_buffer_standard_layout", "subgroup_id" ]
};
...
function _emwgpuAdapterRequestDevice(adapterPtr, futureId, deviceLostFutureId, devicePtr, queuePtr, descriptor) {
  ...
  if (descriptor) {
    ...
    if (limitsPtr) {
      assert(limitsPtr);
      assert(Number((growMemViews(), HEAPU64)[((limitsPtr) >> 3)]) === 0);
      var requiredLimits = {};
...
function _emwgpuInstanceRequestAdapter(instancePtr, futureId, options, adapterPtr) {
  ...
  if (options) {
    ...
    if (nextInChainPtr !== 0) {
      var sType = (growMemViews(), HEAP32)[(((nextInChainPtr) + (8)) >> 2)];
      assert(sType === 11);
      assert(0 === Number((growMemViews(), HEAPU64)[((nextInChainPtr) >> 3)]));
      var webxrOptions = nextInChainPtr;
      assert(webxrOptions);
      assert(Number((growMemViews(), HEAPU64)[((webxrOptions) >> 3)]) === 0);
...
var get_system_prompt_inner = function(ptr, len, waitPtr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 0, 1, ptr, len, waitPtr);
  ptr = bigintToI53Checked(ptr);
  waitPtr = bigintToI53Checked(waitPtr);
...
function _get_system_prompt(ptr, len) {
  ptr = bigintToI53Checked(ptr);
  var waitPtr = _malloc(8);
  Atomics.store((growMemViews(), HEAP32), waitPtr >>> 2, -1);
...
var recv_peer_inner = function(fd, ptr, len, waitPtr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 0, 1, fd, ptr, len, waitPtr);
  ptr = bigintToI53Checked(ptr);
  waitPtr = bigintToI53Checked(waitPtr);
  var curptr = ptr;
  var writeCB = res => {
...
function register_buf(fd, ptr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(30, 0, 1, fd, ptr);
  ptr = bigintToI53Checked(ptr);
...
function _send_peer(fd, ptr, len) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(31, 0, 1, fd, ptr, len);
  ptr = bigintToI53Checked(ptr);
  if (Module.PeerManager == null) return -1;
...
var emwgpuStringToInt_FeatureName = {
  ...
  "chromium-experimental-multi-draw-indirect": 327730
};
...
function _wgpuAdapterGetFeatures(adapterPtr, supportedFeatures) {
  ...
  for (const feature of adapter.features) {
    ...
    if (featureEnumValue >= 0) {
      (growMemViews(), HEAP32)[(((featuresPtr) + (offset)) >> 2)] = featureEnumValue;
      offset += 4;
      numFeatures++;
    }
  }
  (growMemViews(), HEAPU64)[(((supportedFeatures) + (8)) >> 3)] = BigInt(featuresPtr);
  (growMemViews(), HEAPU64)[((supportedFeatures) >> 3)] = BigInt(numFeatures);
}
  ...
  var ret = (() => {
    ...
    function makeEntry(entryPtr) {
      ...
      WebGPU.iterateExtensions(entryPtr, {
        327681: ptr => {
          externalTexturePtr = Number((growMemViews(), HEAPU64)[(((ptr) + (16)) >> 3)]);
        }
      });
      ...
      return {
        "binding": (growMemViews(), HEAPU32)[(((entryPtr) + (8)) >> 2)],
        "resource": resource
      };
    }
...
var unexportedSymbols = [ "run", "out", "err", "callMain", "abort", "wasmExports", "HEAPF32", "HEAPF64", "HEAP8", "HEAPU8", "HEAP16", "HEAPU16", "HEAP32", "HEAPU32", "HEAP64", "HEAPU64", "writeStackCookie", "checkStackCookie", "writeI53ToI64", "readI53FromI64", "readI53FromU64", "INT53_MAX", "INT53_MIN", "bigintToI53Checked", "stackSave", "stackRestore", "stackAlloc", "createNamedFunction", "ptrToString", "zeroMemory", "exitJS", "getHeapMax", "growMemory", "ERRNO_CODES", "strError", "DNS", "Protocols", "Sockets", "timers", "warnOnce", "readEmAsmArgsArray", "getExecutableName", "dynCallLegacy", "dynCall", "handleException", "keepRuntimeAlive", "runtimeKeepalivePush", "runtimeKeepalivePop", "callUserCallback", "maybeExit", "asyncLoad", "alignMemory", "mmapAlloc", "wasmTable", "wasmMemory", "getUniqueRunDependency", "noExitRuntime", "addOnPreRun", "addOnPostRun", "freeTableIndexes", "functionsInTableMap", "setValue", "getValue", "PATH", "PATH_FS", "UTF8Decoder", "UTF8ArrayToString", "UTF8ToString", "stringToUTF8Array", "stringToUTF8", "lengthBytesUTF8", "intArrayFromString", "UTF16Decoder", "stringToNewUTF8", "stringToUTF8OnStack", "JSEvents", "specialHTMLTargets", "findCanvasEventTarget", "currentFullscreenStrategy", "restoreOldWindowedStyle", "UNWIND_CACHE", "ExitStatus", "getEnvStrings", "checkWasiClock", "doReadv", "doWritev", "initRandomFill", "randomFill", "emSetImmediate", "emClearImmediate_deps", "emClearImmediate", "promiseMap", "getExceptionMessageCommon", "getCppExceptionTag", "getCppExceptionThrownObjectFromWebAssemblyException", "Browser", "requestFullscreen", "requestFullScreen", "setCanvasSize", "getUserMedia", "createContext", "getPreloadedImageData__data", "wget", "MONTH_DAYS_REGULAR", "MONTH_DAYS_LEAP", "MONTH_DAYS_REGULAR_CUMULATIVE", "MONTH_DAYS_LEAP_CUMULATIVE", "SYSCALLS", "preloadPlugins", "FS_createPreloadedFile", "FS_modeStringToFlags", "FS_getMode", "FS_stdin_getChar_buffer", "FS_stdin_getChar", "FS_readFile", "FS_root", "FS_mounts", "FS_devices", "FS_streams", "FS_nextInode", "FS_nameTable", "FS_currentPath", "FS_initialized", "FS_ignorePermissions", "FS_filesystems", "FS_syncFSRequests", "FS_lookupPath", "FS_getPath", "FS_hashName", "FS_hashAddNode", "FS_hashRemoveNode", "FS_lookupNode", "FS_createNode", "FS_destroyNode", "FS_isRoot", "FS_isMountpoint", "FS_isFile", "FS_isDir", "FS_isLink", "FS_isChrdev", "FS_isBlkdev", "FS_isFIFO", "FS_isSocket", "FS_flagsToPermissionString", "FS_nodePermissions", "FS_mayLookup", "FS_mayCreate", "FS_mayDelete", "FS_mayOpen", "FS_checkOpExists", "FS_nextfd", "FS_getStreamChecked", "FS_getStream", "FS_createStream", "FS_closeStream", "FS_dupStream", "FS_doSetAttr", "FS_chrdev_stream_ops", "FS_major", "FS_minor", "FS_makedev", "FS_registerDevice", "FS_getDevice", "FS_getMounts", "FS_syncfs", "FS_mount", "FS_unmount", "FS_lookup", "FS_mknod", "FS_statfs", "FS_statfsStream", "FS_statfsNode", "FS_create", "FS_mkdir", "FS_mkdev", "FS_symlink", "FS_rename", "FS_rmdir", "FS_readdir", "FS_readlink", "FS_stat", "FS_fstat", "FS_lstat", "FS_doChmod", "FS_chmod", "FS_lchmod", "FS_fchmod", "FS_doChown", "FS_chown", "FS_lchown", "FS_fchown", "FS_doTruncate", "FS_truncate", "FS_ftruncate", "FS_utime", "FS_open", "FS_close", "FS_isClosed", "FS_llseek", "FS_read", "FS_write", "FS_mmap", "FS_msync", "FS_ioctl", "FS_writeFile", "FS_cwd", "FS_chdir", "FS_createDefaultDirectories", "FS_createDefaultDevices", "FS_createSpecialDirectories", "FS_createStandardStreams", "FS_staticInit", "FS_init", "FS_quit", "FS_findObject", "FS_analyzePath", "FS_createFile", "FS_forceLoadFile", "FS_absolutePath", "FS_createFolder", "FS_createLink", "FS_joinPath", "FS_mmapAlloc", "FS_standardizePath", "MEMFS", "PIPEFS", "SOCKFS", "tempFixedLengthArray", "miniTempWebGLFloatBuffers", "miniTempWebGLIntBuffers", "GL", "AL", "GLUT", "EGL", "GLEW", "IDBStore", "runAndAbortIfError", "Asyncify", "Fibers", "SDL", "SDL_gfx", "waitAsyncPolyfilled", "print", "printErr", "jstoi_s", "terminateWorker", "cleanupThread", "registerTLSInit", "spawnThread", "exitOnMainThread", "proxyToMainThread", "proxiedJSCallArgs", "invokeEntryPoint", "checkMailbox", "recv_peer_inner", "register_buf", "connect_peer_inner", "accept_peer_inner", "close_peer_inner", "get_next_prompt_inner", "get_system_prompt_inner", "cache_get_inner", "cache_put_inner", "WebGPU", "emwgpuStringToInt_BufferMapState", "emwgpuStringToInt_CompilationMessageType", "emwgpuStringToInt_DeviceLostReason", "emwgpuStringToInt_FeatureName", "emwgpuStringToInt_PreferredFormat" ];
...
var dynCall_vijjjjjji = makeInvalidEarlyAccess("dynCall_vijjjjjji");
...
var dynCall_jjjii = makeInvalidEarlyAccess("dynCall_jjjii");
...
var dynCall_ifj = makeInvalidEarlyAccess("dynCall_ifj");
...
var dynCall_jjjjij = makeInvalidEarlyAccess("dynCall_jjjjij");
...
var dynCall_jjjjid = makeInvalidEarlyAccess("dynCall_jjjjid");

var dynCall_jjjjijj = makeInvalidEarlyAccess("dynCall_jjjjijj");

var dynCall_jjjjjjjii = makeInvalidEarlyAccess("dynCall_jjjjjjjii");

var dynCall_jjjjijii = makeInvalidEarlyAccess("dynCall_jjjjijii");

var dynCall_jjjjijjj = makeInvalidEarlyAccess("dynCall_jjjjijjj");

var dynCall_jjjijijj = makeInvalidEarlyAccess("dynCall_jjjijijj");

var dynCall_jjjijij = makeInvalidEarlyAccess("dynCall_jjjijij");

var dynCall_vjjjiij = makeInvalidEarlyAccess("dynCall_vjjjiij");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["dynCall_vijjjjjji"] != "undefined", "missing Wasm export: dynCall_vijjjjjji");
  ...
  assert(typeof wasmExports["dynCall_jjjii"] != "undefined", "missing Wasm export: dynCall_jjjii");
  ...
  assert(typeof wasmExports["dynCall_ifj"] != "undefined", "missing Wasm export: dynCall_ifj");
  ...
  assert(typeof wasmExports["dynCall_jjjjij"] != "undefined", "missing Wasm export: dynCall_jjjjij");
  ...
  assert(typeof wasmExports["dynCall_jjjjid"] != "undefined", "missing Wasm export: dynCall_jjjjid");
  assert(typeof wasmExports["dynCall_jjjjijj"] != "undefined", "missing Wasm export: dynCall_jjjjijj");
  assert(typeof wasmExports["dynCall_jjjjjjjii"] != "undefined", "missing Wasm export: dynCall_jjjjjjjii");
  assert(typeof wasmExports["dynCall_jjjjijii"] != "undefined", "missing Wasm export: dynCall_jjjjijii");
  assert(typeof wasmExports["dynCall_jjjjijjj"] != "undefined", "missing Wasm export: dynCall_jjjjijjj");
  assert(typeof wasmExports["dynCall_jjjijijj"] != "undefined", "missing Wasm export: dynCall_jjjijijj");
  assert(typeof wasmExports["dynCall_jjjijij"] != "undefined", "missing Wasm export: dynCall_jjjijij");
  assert(typeof wasmExports["dynCall_vjjjiij"] != "undefined", "missing Wasm export: dynCall_vjjjiij");
  ...
  dynCall_vijjjjjji = dynCalls["vijjjjjji"] = createExportWrapper("dynCall_vijjjjjji", 9);
  ...
  dynCall_jjjii = dynCalls["jjjii"] = createExportWrapper("dynCall_jjjii", 5);
  ...
  dynCall_ifj = dynCalls["ifj"] = createExportWrapper("dynCall_ifj", 3);
  ...
  dynCall_jjjjij = dynCalls["jjjjij"] = createExportWrapper("dynCall_jjjjij", 6);
  ...
  dynCall_jjjjii = dynCalls["jjjjii"] = createExportWrapper("dynCall_jjjjii", 6);
  dynCall_jjjjid = dynCalls["jjjjid"] = createExportWrapper("dynCall_jjjjid", 6);
  dynCall_jjjjijj = dynCalls["jjjjijj"] = createExportWrapper("dynCall_jjjjijj", 7);
  dynCall_jjjjjjjii = dynCalls["jjjjjjjii"] = createExportWrapper("dynCall_jjjjjjjii", 9);
  dynCall_jjjjijii = dynCalls["jjjjijii"] = createExportWrapper("dynCall_jjjjijii", 8);
  dynCall_jjjjijjj = dynCalls["jjjjijjj"] = createExportWrapper("dynCall_jjjjijjj", 8);
  dynCall_jjjijijj = dynCalls["jjjijijj"] = createExportWrapper("dynCall_jjjijijj", 8);
  dynCall_jjjijij = dynCalls["jjjijij"] = createExportWrapper("dynCall_jjjijij", 7);
  dynCall_vjjjiij = dynCalls["vjjjiij"] = createExportWrapper("dynCall_vjjjiij", 7);
  dynCall_vjjjjii = dynCalls["vjjjjii"] = createExportWrapper("dynCall_vjjjjii", 7);
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ get_system_prompt: _get_system_prompt,
    /** @export */ is_decoding_cancel: _is_decoding_cancel,
    /** @export */ memory: wasmMemory,
    /** @export */ random_get: _random_get,
    /** @export */ recv_peer: _recv_peer,
    /** @export */ send_peer: _send_peer,
    /** @export */ wgpuAdapterGetFeatures: _wgpuAdapterGetFeatures,
